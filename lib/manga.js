...
exports.getMangaStatus = function (token, status) {
    if (token === undefined) {
        console.error('ERROR - getMangaStatus: Parameter `token` is missing');
        return;
    }
...
exports.getMangaIdFeed = function (mangaId, options) {
    if (mangaId === undefined) {
        console.error('ERROR - getMangaIdFeed: Parameter `mangaId` is missing');
        return;
    } else if (mangaId === '') {
 ...
 * @param {GetMangaIdAggregateRequestOptions} [options] See {@link GetMangaAggregateRequestOptions}
...
exports.getMangaIdAggregate = function (mangaId, options) {
    if (mangaId === undefined) {
        console.error('ERROR - getMangaIdAggregate: Parameter `mangaId` is missing');
        return;
    } else if (mangaId === '') {
